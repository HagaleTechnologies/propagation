...
- [Does M1 clear ARCHITECTURE.md's "each rung must beat the previous" gate?](pages/question-p533-worse-than-climatology.md) — ARCHITECTURE.md §5 states the modeling ladder is "strictly ordered; each rung [draft]
